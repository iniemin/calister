...
<b>👮‍♂ Silakan Hubungi @MrCalister . </b>
""",
...
async def cb_bayar_dulu(client, m, _):
    msg = f"""
<b><blockquote>✅ Jika anda sudah setuju dengan syarat & ketentuan, Silahkan hubungi 😈 @MrCalister untuk mendapatkan akses membuat userbot.</b></blockquote>
<b>Created by {Ads()}</b>"""
...
async def bikin_ubot(client, m, _):
    ...
    if kn_client.me.id not in seles:
        try:
            ...
            pass
    try:
        await kn_client.join_chat("urdaddych")
